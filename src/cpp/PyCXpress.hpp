...
namespace PyCXpress
{
    ...
    public:
        ...
        Buffer(Buffer &&ohs) : m_size(ohs.m_size), m_data(ohs.m_data), m_converter(ohs.m_converter)
        {
            ohs.m_data = nullptr;
        }
    ...
    {
    public:
        explicit PythonInterpreter(bool init_signal_handlers = true,
                                   int argc = 0,
        ...
        void *set_buffer(const std::string &name, const std::vector<size_t> &shape)
        {
